...
docker run -t --rm -v "%project_dir%":/katalon/katalon/source -v "%reports_dir%":/katalon/katalon/report -e KATALON_OPTS=%katalon_opts% katalonstudio/katalon:test katalon-execute
