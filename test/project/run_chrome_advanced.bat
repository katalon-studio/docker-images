...
docker run --rm -v "%project_dir%":/katalon/katalon/source -v "%reports_dir%":/katalon/katalon/report -e KATALON_OPTS=%katalon_opts% -it katalon-katalon katalon-execute.sh
